...
void main() {
  ...
  if (uWebcamMirrorActive > 0.5) {
    ...
    if (targetGridUV.x >= 0.0 && targetGridUV.x <= 1.0 && targetGridUV.y >= 0.0 && targetGridUV.y <= 1.0) {
      ...
      finalColor = mix(finalColor, colorSample.rgb, 0.72 * edgeFade);
    }
  }
