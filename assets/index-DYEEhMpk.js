...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new G(0,1,0);return new Ui({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ki(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Fl=class{constructor(){r(this,`hidden`,new Float32Array(8)),r(this,`headRot`,new G(0,0,0)),r(this,`neckRot`,new G(0,0,0)),r(this,`torsoRot`,new G(0,0,0)),r(this,`attention`,0)}update(e,t,n,r,i){let a=Math.min(3,i*60);Math.abs(e)+Math.abs(t)+n>.05?this.attention+=(1-this.attention)*.06*a:this.attention+=(0-this.attention)*.02*a,this.attention=Vt.clamp(this.attention,0,1);let o=Date.now()*.001,s=Math.sin(o*.6)*.15+Math.cos(o*1.3)*.05,c=Math.cos(o*.8)*.1+Math.sin(o*1)*.03,l=Vt.lerp(s,e,this.attention),u=Vt.lerp(c,t,this.attention),d=new Float32Array(8),f=[l,u,n,Math.sin(o*2)];for(let e=0;e<8;e++){let t=0;for(let n=0;n<8;n++)t+=this.hidden[n]*Math.sin(e*1.3+n*.8)*.15;t+=f[0]*Math.cos(e*.9)*.25,t+=f[1]*Math.sin(e*1.2)*.25,t+=f[2]*Math.sin(e*2.1)*.15,t+=f[3]*.1,d[e]=Math.tanh(t)}this.hidden=d;let p=0,m=0,h=0;for(let e=0;e<8;e++)m+=this.hidden[e]*Math.sin(e*1.9)*.45,p+=this.hidden[e]*Math.cos(e*2.4)*.35,h+=this.hidden[e]*Math.sin(e*3.1)*.2;let g=Math.sin(o*1.6)*.015,_=Math.sin(o*3.2)*.005,v=m*.7,y=p*.7,b=h*.8,x=m*.2,S=p*.2,C=m*.1,w=p*.1+g,T=h*.2+_;if(r===`dancing`){let e=3.5;C+=Math.sin(o*e)*.18,T+=Math.cos(o*e)*.1,S+=Math.abs(Math.sin(o*e*2))*.08-.04,v+=Math.cos(o*e*.5)*.15}let E=.08*a;this.headRot.x+=(y-this.headRot.x)*Math.min(1,E),this.headRot.y+=(v-this.headRot.y)*Math.min(1,E),this.headRot.z+=(b-this.headRot.z)*Math.min(1,E),this.neckRot.x+=(S-this.neckRot.x)*Math.min(1,E),this.neckRot.y+=(x-this.neckRot.y)*Math.min(1,E),this.torsoRot.x+=(w-this.torsoRot.x)*Math.min(1,E),this.torsoRot.y+=(C-this.torsoRot.y)*Math.min(1,E),this.torsoRot.z+=(T-this.torsoRot.z)*Math.min(1,E)}getHeadRot(){return this.headRot}getNeckRot(){return this.neckRot}getTorsoRot(){return this.torsoRot}},Il=class{constructor(){r(this,`group`,void 0),r(this,`material`,void 0),r(this,`pointsMesh`,void 0),r(this,`humanBustGeom`,void 0),r(this,`bearBustGeom`,void 0),r(this,`rnn`,new Fl),this.group=new Ln,this.material=new Ui({vertexShader:Nl,fragmentShader:Pl,uniforms:{uTime:{value:0},uColor:{value:new X(`#ffffff`)},uSize:{value:2.2},uMouthOpen:{value:0},uEyeOpen:{value:1},uHeadRot:{value:new G(0,0,0)},uNeckRot:{value:new G(0,0,0)},uTorsoRot:{value:new G(0,0,0)}},transparent:!0,depthWrite:!1,blending:2}),this.humanBustGeom=this.createParametricBust(!1),this.bearBustGeom=this.createParametricBust(!0),this.pointsMesh=new Ei(this.humanBustGeom,this.material),this.group.add(this.pointsMesh)}createParametricBust(e){let t=e?3e4:25e3,n=new Float32Array(t*3),r=new Float32Array(t);for(let i=0;i<t;i++){let t=0,a=0,o=0,s=0;if(e&&i>=25e3)if(i<27500){let e=Math.random()*Math.PI*2,n=Math.random()*.12,r=.09;t=r*Math.cos(e),a=.58+r*Math.sin(e),o=.2+n,s=1}else if(i<28750){let e=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);t=-.2+.08*Math.sin(n)*Math.cos(e),a=.76+.08*Math.sin(n)*Math.sin(e),o=.04+.08*Math.cos(n),s=1}else{let e=Math.random()*Math.PI*2,n=Math.acos(Math.random()*2-1);t=.2+.08*Math.sin(n)*Math.cos(e),a=.76+.08*Math.sin(n)*Math.sin(e),o=.04+.08*Math.cos(n),s=1}else{a=Math.random()*1.3-.55;let n=0,r=0;if(a<.22){let t=(a- -.55)/.77;e?(n=Vt.lerp(.28,.36,t),r=Vt.lerp(.28,.36,t)):(n=Vt.lerp(.16,.44,t),r=Vt.lerp(.12,.18,t))}else if(a<.32){let t=(a-.22)/.1,i=(1+Math.cos(t*Math.PI))/2;e?(n=Vt.lerp(.16,.36,i),r=Vt.lerp(.16,.36,i)):(n=Vt.lerp(.065,.44,i),r=Vt.lerp(.065,.18,i))}else if(a<.48)n=e?.16:.065,r=e?.16:.065;else{let t=e?.28:.22,i=Math.abs(a-.6),o=t*t-i*i,c=o>0?Math.sqrt(o):.05;n=Math.max(.05,c),r=Math.max(.05,c),s=1}let i=Math.random()*Math.PI*2;t=n*Math.cos(i),o=r*Math.sin(i)}n[i*3]=t,n[i*3+1]=a,n[i*3+2]=o,r[i]=s}let i=new Br;return i.setAttribute(`position`,new Tr(n,3)),i.setAttribute(`aIsHead`,new Tr(r,1)),i}animate(e,t,n,r,i,a,o,s,c,l,u,d){let f=r===`bear`?this.bearBustGeom:this.humanBustGeom;this.pointsMesh.geometry!==f&&(this.pointsMesh.geometry=f);let p=e%3.5,m=1;if(p>3.35){let e=(p-3.35)/.15*Math.PI;m=Vt.lerp(1,.05,Math.abs(Math.sin(e)))}let h=i.length()+a.length()+o.length(),g=s*4.5,_=g>.05?g:n?1:Math.max(0,Math.min(1,h*2.8)),v=_>.05?.15+Math.abs(Math.sin(e*16))*1.5*_:.05,y=t.x*.5+o.x*2,b=t.y*.4+o.y*1.5;this.rnn.update(y,b,d,r,u),this.material.uniforms.uTime.value=e,this.material.uniforms.uColor.value.copy(c),this.material.uniforms.uSize.value=l,this.material.uniforms.uMouthOpen.value=v,this.material.uniforms.uEyeOpen.value=m,this.material.uniforms.uHeadRot.value.copy(this.rnn.getHeadRot()),this.material.uniforms.uNeckRot.value.copy(this.rnn.getNeckRot()),this.material.uniforms.uTorsoRot.value.copy(this.rnn.getTorsoRot()),this.group.position.set(0,r===`bear`?-1.8:-2.2,0)}},Ll=class{constructor(){r(this,`ctx`,null),r(this,`masterGain`,null),r(this,`isMuted`,!1),r(this,`targetVolume`,.4),r(this,`droneOscs`,[]),r(this,`droneGains`,[]),r(this,`filter`,null),r(this,`lfo`,null),r(this,`lfoGain`,null),r(this,`delayNode`,null),r(this,`delayGain`,null),r(this,`maxChimeVoices`,4),r(this,`activeChimes`,0),r(this,`droneFrequencies`,[65.41,77.78,87.31,98,116.54]),r(this,`chimeFrequencies`,[261.63,293.66,329.63,392,440,523.25,587.33,659.25,783.99,880,1046.5,1174.66,1318.51,1567.98])}init(){var e=this;return s(function*(){if(!e.ctx)try{e.ctx=new(window.AudioContext||window.webkitAudioContext),e.ctx.state===`suspended`&&(yield e.ctx.resume()),e.masterGain=e.ctx.createGain(),e.masterGain.gain.setValueAtTime(e.isMuted?0:e.targetVolume,e.ctx.currentTime),e.masterGain.connect(e.ctx.destination),e.delayNode=e.ctx.createDelay(2),e.delayGain=e.ctx.createGain(),e.delayNode.delayTime.setValueAtTime(.8,e.ctx.currentTime),e.delayGain.gain.setValueAtTime(.4,e.ctx.currentTime),e.delayNode.connect(e.delayGain),e.delayGain.connect(e.delayNode),e.delayNode.connect(e.masterGain),e.filter=e.ctx.createBiquadFilter(),e.filter.type=`lowpass`,e.filter.frequency.setValueAtTime(300,e.ctx.currentTime),e.filter.Q.setValueAtTime(3,e.ctx.currentTime),e.filter.connect(e.masterGain),e.lfo=e.ctx.createOscillator(),e.lfoGain=e.ctx.createGain(),e.lfo.type=`sine`,e.lfo.frequency.setValueAtTime(.08,e.ctx.currentTime),e.lfoGain.gain.setValueAtTime(150,e.ctx.currentTime),e.lfo.connect(e.lfoGain),e.filter.frequency&&e.lfoGain.connect(e.filter.frequency),e.lfo.start(),e.startDrone(),console.log(`Audio Engine successfully initialized`)}catch(e){console.error(`Failed to initialize Audio Engine:`,e)}})()}startDrone(){!this.ctx||!this.filter||[0,2,4].forEach(e=>{if(!this.ctx||!this.filter)return;let t=this.ctx.createOscillator(),n=this.ctx.createGain();t.type=`triangle`,t.frequency.setValueAtTime(this.droneFrequencies[e],this.ctx.currentTime),n.gain.setValueAtTime(.15,this.ctx.currentTime),t.connect(n),n.connect(this.filter),t.start(),this.droneOscs.push(t),this.droneGains.push(n)})}triggerChime(e=.5){if(!this.ctx||!this.masterGain||this.isMuted||this.activeChimes>=this.maxChimeVoices)return;this.activeChimes++;let t=this.ctx.currentTime,n=Math.floor(Math.random()*this.chimeFrequencies.length),r=this.chimeFrequencies[n],i=this.ctx.createOscillator(),a=this.ctx.createOscillator(),o=this.ctx.createGain(),s=this.ctx.createGain();i.type=`sine`,i.frequency.setValueAtTime(r,t),a.type=`sine`,a.frequency.setValueAtTime(r*1.5,t),o.gain.setValueAtTime(r*.8*e,t),o.gain.exponentialRampToValueAtTime(.1,t+1.2),s.gain.setValueAtTime(0,t),s.gain.linearRampToValueAtTime(.08*e,t+.05),s.gain.exponentialRampToValueAtTime(1e-4,t+2.5),a.connect(o),o.connect(i.frequency),i.connect(s),s.connect(this.masterGain),this.delayNode&&s.connect(this.delayNode),i.start(t),a.start(t),i.stop(t+3),a.stop(t+3),setTimeout(()=>{this.activeChimes=Math.max(0,this.activeChimes-1)},3e3)}setVolume(e){this.targetVolume=Math.max(0,Math.min(1,e/100)),this.ctx&&this.masterGain&&!this.isMuted&&this.masterGain.gain.setTargetAtTime(this.targetVolume,this.ctx.currentTime,.1)}modulateFilter(e){if(this.ctx&&this.filter){let t=120+Math.max(0,e-.2)*500;this.filter.frequency.setTargetAtTime(Math.min(2e3,t),this.ctx.currentTime,.3)}}setMute(e){if(this.isMuted=e,this.ctx&&this.masterGain){let t=e?0:this.targetVolume;this.masterGain.gain.setTargetAtTime(t,this.ctx.currentTime,.15)}}};function Rl(){let e=4,t,n=`desktop`,r=`Unknown GPU`,i=`Unknown Vendor`,a=!1,o=!1,s=``;try{e=navigator.hardwareConcurrency||4,t=navigator.deviceMemory;let c=navigator.userAgent||``,l=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(c),u=`ontouchstart`in window||navigator&&navigator.maxTouchPoints>0;n=l||u&&window.innerWidth<1024?`mobile`:`desktop`,/SmartTV|Tizen|Web0S|MapGuide|Opera TV|SamsungBrowser/i.test(c)&&(o=!0,s=`Smart TV browser detected (hardware constraints)`);let d=document.createElement(`canvas`),f=d.getContext(`webgl2`)||d.getContext(`webgl`)||d.getContext(`experimental-webgl`);if(f){a=typeof WebGL2RenderingContext<`u`&&f instanceof WebGL2RenderingContext?!!f.getExtension(`EXT_color_buffer_float`):!!f.getExtension(`OES_texture_float`);let e=f.getExtension(`WEBGL_debug_renderer_info`);e&&(r=f.getParameter(e.UNMASKED_RENDERER_WEBGL)||`Unknown GPU`,i=f.getParameter(e.UNMASKED_VENDOR_WEBGL)||`Unknown Vendor`)}}catch(e){console.error(`Error during hardware detection, applying safe fallback:`,e),o=!0,s=`Hardware diagnostics failed to complete`}if(!o&&(a?n===`mobile`?(o=!0,s=`Mobile device resources are constrained`):e<4?(o=!0,s=`Low CPU core count`):t&&t<=4&&(o=!0,s=`Limited device RAM`):(o=!0,s=`WebGL float texture filtering is not supported by your browser/hardware`),!o&&r)){let e=r.toLowerCase(),t=[`intel`,`hd graphics`,`uhd graphics`,`iris`,`adreno`,`mali`,`powervr`,`radeon r`,`geforce gt`,`software`,`swiftshader`,`basic render`],n=[`rtx`,`gtx`,`radeon rx`,`apple m`,`apple a`,`quadro`,`tesla`],i=t.some(t=>e.includes(t)),a=n.some(t=>e.includes(t));i&&!a&&(o=!0,s=`Integrated / mobile graphics processor detected`)}return{deviceType:n,cores:e,memoryGb:t,gpuRenderer:r,gpuVendor:i,isLowEnd:o,warningReason:s}}var zl=class{static init(){let e=console.log,t=console.warn,n=console.error;console.log=(...t)=>{e.apply(console,t),this.addLog(t.map(e=>typeof e==`object`?JSON.stringify(e):e).join(` `),`info`)},console.warn=(...e)=>{t.apply(console,e),this.addLog(e.map(e=>typeof e==`object`?JSON.stringify(e):e).join(` `),`warn`)},console.error=(...e)=>{n.apply(console,e),this.addLog(e.map(e=>typeof e==`object`?JSON.stringify(e):e).join(` `),`error`)},window.onerror=(e,t,n,r,i)=>{let a=`CRITICAL UNCAUGHT: ${e} at ${t}:${n}:${r}${i?` - Stack: ${i.stack}`:``}`;return this.addLog(a,`error`),!1},window.onunhandledrejection=e=>{this.addLog(`UNHANDLED PROMISE REJECTION: ${e.reason}`,`error`)},console.log(`DiagnosticLogger initialized successfully.`)}static addLog(e,t){let n=`[${new Date().toISOString().substring(11,19)}] ${e}`;if(this.logs.push(n),this.onLogAdded)try{this.onLogAdded(n,t)}catch(e){}}static getLogs(){return this.logs}static subscribe(e){this.onLogAdded=e,this.logs.forEach(t=>{let n=t.includes(`ERROR:`)||t.includes(`CRITICAL`),r=t.includes(`WARN:`);e(t,n?`error`:r?`warn`:`info`)})}};r(zl,`logs`,[]),r(zl,`onLogAdded`,void 0),zl.init();var $,Bl,Vl=0,Hl=!1,Ul=document.getElementById(`splash-overlay`),Wl=document.getElementById(`enter-btn`),Gl=document.getElementById(`dashboard`),Kl=document.getElementById(`dashboard-tab`),ql=document.getElementById(`fullscreen-btn`),Jl=document.querySelectorAll(`.preset-card`),Yl=document.getElementById(`speed-slider`),Xl=document.getElementById(`speed-val`),Zl=document.getElementById(`turbulence-slider`),Ql=document.getElementById(`turbulence-val`),$l=document.getElementById(`particle-slider`),eu=document.getElementById(`particle-val`),tu=document.getElementById(`volume-slider`),nu=document.getElementById(`volume-val`),ru=document.getElementById(`audio-toggle`),iu=document.getElementById(`webcam-toggle`),au=document.getElementById(`friend-toggle`),ou=document.getElementById(`friend-shape`),su=document.getElementById(`friend-shape-group`),cu=document.getElementById(`friend-camera-toggle`),lu=document.getElementById(`crowd-slider`),uu=document.getElementById(`crowd-val`),du=document.getElementById(`time-select`),fu=document.getElementById(`light-mode-toggle`),pu=document.getElementById(`record-btn`);function mu(e){requestAnimationFrame(mu);let t=e*.001,n=Math.min(t-Vl,.1);if(Vl=t,$&&$.update(n,t),Bl&&Hl&&$){let e=$.getAverageVelocity();if(Bl.modulateFilter(e),e>1.15&&Math.random()<.08){let t=Math.min(1,(e-1.15)*1.5);Bl.triggerChime(t)}}Bl&&Hl&&Math.random()<.002&&parseFloat(Zl.value)>2&&Bl.triggerChime(.5+Math.random()*.5)}function hu(){return gu.apply(this,arguments)}function gu(){return gu=s(function*(){if(Hl)return;Hl=!0,Bl=new Ll,yield Bl.init();let e=document.getElementById(`lite-mode-checkbox`),t=e?e.checked:!1;$=new Ml(`webgl-canvas`,t?256:512),$l&&eu&&(t?($l.value=`1`,eu.textContent=`65,536 (Low)`):($l.value=`2`,eu.textContent=`262,144 (Medium)`)),Bl.setVolume(parseInt(tu.value)),Bl.setMute(!ru.checked),Ul.classList.add(`hidden`),setTimeout(()=>{Gl.style.display=`flex`},1e3),_u(),Vl=performance.now()*.001,requestAnimationFrame(mu)}),gu.apply(this,arguments)}function _u(){let e=document.documentElement;e.requestFullscreen?e.requestFullscreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen&&e.msRequestFullscreen()}function vu(){!document.fullscreenElement&&!document.webkitFullscreenElement?_u():document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen()}var yu=!1;function bu(){let e=document.getElementById(`lite-mode-checkbox`),t=document.getElementById(`hardware-status-text`),n=document.getElementById(`hardware-warning`),r=document.getElementById(`hardware-warning-desc`),i=document.getElementById(`hardware-panel`),a=document.getElementById(`lite-mode-label-text`),o=document.getElementById(`debug-console`),s=document.getElementById(`close-debug-btn`),c=document.getElementById(`debug-console-logs`);if(!e||!t||!n||!r||!i)return;c&&zl.subscribe((e,t)=>{let n=document.createElement(`div`);n.className=`log-entry-${t}`,n.textContent=e,c.appendChild(n),c.scrollTop=c.scrollHeight}),s&&o&&s.addEventListener(`click`,e=>{e.stopPropagation(),o.style.display=`none`}),window.addEventListener(`keydown`,e=>{if((e.key===`d`||e.key===`D`)&&o){let e=o.style.display===`none`;o.style.display=e?`flex`:`none`}});let l=o=>{i.classList.contains(`status-success`)||i.classList.contains(`status-warning`)||(yu=!0,i.classList.add(`status-warning`),t.textContent=`Hardware status: Unknown`,r.textContent=`${o}. Lite Mode has been automatically enabled to ensure smooth performance.`,n.style.display=`flex`,e.checked=!0,a.textContent=`Enable Lite Mode (Auto-enabled for performance)`,a.style.color=`#ff9f1c`)},u=setTimeout(()=>{l(`We could not verify your graphics hardware capabilities`)},2500);try{let o=Rl();clearTimeout(u),yu=o.isLowEnd;let s=o.gpuRenderer||`Unknown GPU`;if(s=s.replace(/\s*\(tm\)|\s*\(r\)/gi,``).replace(/direct3d\d*\s*v\s*|driver\s*|device\s*|angle\s*\(|opengl\s*.*|\)/gi,``).trim(),o.isLowEnd){i.classList.add(`status-warning`);let c=/Tizen|SmartTV|Web0S/i.test(navigator.userAgent),l=!!(o.warningReason&&o.warningReason.indexOf(`failed`)!==-1),u=!!(o.gpuRenderer&&o.gpuRenderer.indexOf(`Unknown`)!==-1);c||l||u?(t.textContent=`Hardware status: Unknown / Constrained`,r.textContent=`We could not verify your graphics hardware capabilities or a TV display was detected. Lite Mode is suggested to ensure smooth performance.`):(t.textContent=`Hardware: Integrated / Mobile (${s})`,r.textContent=`${o.warningReason||`Constrained graphical resources`}. Lite Mode has been automatically enabled to protect your device from freezing or lagging.`),n.style.display=`flex`,e.checked=!0,a.textContent=`Enable Lite Mode (Auto-enabled for performance)`,a.style.color=`#ff9f1c`}else i.classList.add(`status-success`),t.textContent=`Hardware status: High Performance (${s})`,a.textContent=`Enable Lite Mode (Optimize for battery/heat)`}catch(e){console.error(`Uncaught diagnostics error:`,e),clearTimeout(u),l(`An error occurred while evaluating your graphics hardware`)}e.addEventListener(`change`,t=>{yu&&!e.checked&&(confirm(`WARNING: Disabling Lite Mode on this device may cause the particle simulation to lag severely or crash your browser.

Are you sure you want to run the full simulation?`)||(e.checked=!0,t.preventDefault()))})}var xu=!1;function Su(){if(xu)return;xu=!0,bu(),Wl.addEventListener(`click`,()=>hu()),Kl.addEventListener(`click`,()=>{Gl.classList.toggle(`collapsed`)}),Jl.forEach(e=>{e.addEventListener(`click`,()=>{Jl.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=e.getAttribute(`data-preset`);$&&$.applyPreset(t),Bl&&Bl.triggerChime(.8)})}),Yl.addEventListener(`input`,()=>{let e=parseFloat(Yl.value);Xl.textContent=e.toFixed(1)+`x`,$&&$.setSpeed(e)}),Zl.addEventListener(`input`,()=>{let e=parseFloat(Zl.value);Ql.textContent=e.toFixed(1),$&&$.setTurbulence(e)}),$l.addEventListener(`input`,()=>{let e=parseInt($l.value),t=262144,n=`262,144 (Medium)`;e===1?(t=65536,n=`65,536 (Low)`):e===3&&(t=1048576,n=`1,048,576 (High)`),eu.textContent=n,$&&$.setParticleCount(t)}),tu.addEventListener(`input`,()=>{let e=parseInt(tu.value);nu.textContent=e+`%`,Bl&&Bl.setVolume(e)}),ru.addEventListener(`change`,()=>{Bl&&Bl.setMute(!ru.checked)}),lu.addEventListener(`input`,()=>{let e=parseInt(lu.value),t=`Low`;e===1?t=`Medium`:e===2?t=`High`:e===3&&(t=`Max`),uu.textContent=t,$&&$.setCrowdDensity(e),Bl&&e>1&&Bl.triggerChime(.15*e)}),du.addEventListener(`change`,()=>{$&&$.setTimePreset(du.value)}),fu.addEventListener(`change`,()=>{let e=fu.checked;e?document.body.classList.add(`light-mode`):document.body.classList.remove(`light-mode`),$&&$.setLightMode(e)}),iu.addEventListener(`change`,s(function*(){if($){let e=iu.checked;e&&au.checked&&(au.checked=!1,cu.checked=!1,$.setFriendModeActive(!1),$.setFriendMirrorActive(!1),su.style.display=`none`),!(yield $.setWebcamActive(e))&&e&&(iu.checked=!1)}})),au.addEventListener(`change`,()=>{if($){let e=au.checked;e?(iu.checked&&(iu.checked=!1,$.setWebcamActive(!1)),su.style.display=`block`):(su.style.display=`none`,cu.checked=!1,$.setFriendMirrorActive(!1),iu.checked||$.setWebcamActive(!1)),$.setFriendModeActive(e),$.setFriendShape(ou.value)}}),cu.addEventListener(`change`,s(function*(){if($){let e=cu.checked;if(e){if(!(yield $.setWebcamActive(!0))){cu.checked=!1,$.setFriendMirrorActive(!1);return}}else iu.checked||$.setWebcamActive(!1);$.setFriendMirrorActive(e)}})),ou.addEventListener(`change`,()=>{$&&$.setFriendShape(ou.value)}),ql.addEventListener(`click`,()=>vu());let e=null,t=[];pu.addEventListener(`click`,()=>{if(!$)return;let n=document.getElementById(`webgl-canvas`);if(n){if(pu.classList.contains(`recording`)){e&&e.state!==`inactive`&&e.stop();return}t=[];try{let r=n.captureStream?n.captureStream(60):n.mozCaptureStream?n.mozCaptureStream(60):null;if(!r){alert(`Canvas recording is not supported in this browser.`);return}let i={mimeType:`video/webm;codecs=vp9`};MediaRecorder.isTypeSupported(i.mimeType)||(i={mimeType:`video/webm;codecs=vp8`}),MediaRecorder.isTypeSupported(i.mimeType)||(i={mimeType:`video/webm`}),MediaRecorder.isTypeSupported(i.mimeType)||(i={mimeType:``}),e=new MediaRecorder(r,i),e.ondataavailable=e=>{e.data.size>0&&t.push(e.data)},e.onstop=()=>{pu.classList.remove(`recording`),pu.innerHTML=`<span class="record-dot"></span>Record Clip`;let e=new Blob(t,{type:`video/webm`}),n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=`latent-currents-clip.webm`,r.click(),setTimeout(()=>URL.revokeObjectURL(n),100)},pu.classList.add(`recording`),pu.innerHTML=`<span class="record-dot"></span>Recording...`,e.start(),setTimeout(()=>{e&&e.state!==`inactive`&&e.stop()},5e3)}catch(e){console.error(`Failed to record canvas:`,e),alert(`Failed to start recording.`),pu.classList.remove(`recording`),pu.innerHTML=`<span class="record-dot"></span>Record Clip`}}}),window.addEventListener(`mousedown`,e=>{if(!Hl||!Bl)return;let t=e.target;t.closest(`#dashboard`)||t.closest(`#toggle-ui-btn`)||t.closest(`#splash-overlay`)||Bl.triggerChime(.6+Math.random()*.4)}),window.addEventListener(`touchstart`,e=>{if(!Hl||!Bl)return;let t=e.target;t.closest(`#dashboard`)||t.closest(`#toggle-ui-btn`)||t.closest(`#splash-overlay`)||Bl.triggerChime(.5+Math.random()*.3)})}document.addEventListener(`DOMContentLoaded`,()=>{Su()}),(document.readyState===`complete`||document.readyState===`interactive`)&&Su();